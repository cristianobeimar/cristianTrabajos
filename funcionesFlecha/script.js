...
const calcularArea1 = (base, altura) =>
  `el area del retangulo es: ${base * altura}`;
console.log(calcularArea(base, altura));

const calcularPerimetro1 = (base, altura) =>
...
let base2 = parseInt(prompt("ingresa la base del triangulo: "));

const areaTriangulo = (lado1, base) =>
  `el area del triangulo es: ${(base * lado1) / 2}`;

console.log(areaTriangulo(lado1, base));

const perimetroTriangulo = (lado1, base) =>
  `el perimetro del triangulo es: ${lado1 + base}`;
console.log(perimetroTriangulo(lado1, base));

/*4 calcular el area y el perimetro de una circunferencia */

let perimetroC = parseInt(
  prompt("ingresa el valor del perimetro que deseas calcular: ")
);
let areaC = parseInt(prompt("ingresa el valor del area que deseas calcular: "));

const perimetroCircunferencia = (perimetroC, areaC) =>
  `el perimetro de la circunferencia es: ${3.1416 * perimetroC}`;
console.log(perimetroCircunferencia(perimetroC, areaC));

const areaCircunferencia = (perimetroC, areaC) =>
  `el area de la circunferencia es: ${3.1416 * areaC ** 2}`;
...
const areaSuperficial = (volumen) =>
  `el area superficial es: ${6 * volumen ** 2}`;
